...
terms = ["nlp", "cheerful", "bravery","drawing", "satisfactorily", "publisher", "painful", "hardworking", "keys"]
...
# nlp = nlp, bessen = berries, vriendelijkheid = friendliness, hobbelig = bumpy
terms2 = ["nlp", "bessen", "vriendelijkheid", "hobbelig"]
